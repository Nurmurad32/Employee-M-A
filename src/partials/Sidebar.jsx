    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3 cursor-pointer" onClick={() => setSidebarExpanded(!sidebarExpanded)}>
            ...
            <ul className="mt-3">
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        to="/"
                        className={({ isActive }) =>
                          "flex items-center transition duration-150 truncate " + (isActive ? "text-violet-500" : "text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                        }
                      >
              ...
              {/* Table View */}
              <SidebarLinkGroup activecondition={pathname.includes("table-view")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                      ...
                      >
                        <svg className={`shrink-0 fill-current ${pathname.includes("table-view") ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
              ...
              {/* Card View */}
              <SidebarLinkGroup activecondition={pathname.includes("card-view")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                      ...
                      >
                        <svg className={`shrink-0 fill-current ${pathname.includes("card-view") ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 384 512">
                          <path d="M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM128 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM80 432c0-44.2 35.8-80 80-80l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16L96 448c-8.8 0-16-7.2-16-16z" /></svg>
                        <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                          Card View
                        </span>
                      </NavLink>
